...
FOUNDATION_EXPORT NSTimeInterval const SPMBERequestOffersTimeout;
FOUNDATION_EXPORT NSString *const SPMBERewardNotificationText;

FOUNDATION_EXPORT NSString *const SPMBEErrorDialogTitle;
FOUNDATION_EXPORT NSString *const SPMBEErrorDialogMessageDefault;
FOUNDATION_EXPORT NSString *const SPMBEErrorDialogMessageOffline;
FOUNDATION_EXPORT NSString *const SPMBEErrorDialogButtonTitleDismiss;

FOUNDATION_EXPORT NSInteger const SPMBEErrorDialogGenericTag;
FOUNDATION_EXPORT NSInteger const SPMBEErrorDialogStoreKitTag;

FOUNDATION_EXPORT NSString *const SPMBEURLParamValueClient;
FOUNDATION_EXPORT NSString *const SPMBEURLParamValuePlatform;
FOUNDATION_EXPORT NSString *const SPMBEURLParamValueAdFormat;
FOUNDATION_EXPORT NSInteger const SPMBEURLParamValueRewarded;
...
/**
 *  Same as requestOffers but sends the placementId provided to the server
 *
