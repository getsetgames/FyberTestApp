...
static NSString *const kSPActionsBaseURL = @"https://service.sponsorpay.com/actions/v2";
static NSString *const kSPInstallsBaseURL = @"https://service.sponsorpay.com/installs/v2";
static NSString *const kSPVCSBaseURL = @"https://api.sponsorpay.com/vcs/v1/new_credit.json";
static NSString *const kSPMBEBaseURL = @"https://iframe.sponsorpay.com/mbe";
static NSString *const kSPOfferWallWBaseURL = @"https://iframe.sponsorpay.com/mobile";

static NSString *const kSPInterstitialBaseURL = @"https://engine.sponsorpay.com/interstitial";
static NSString *const kSPInterstitialEventURL = @"https://engine.sponsorpay.com/tracker";
static NSString *const kSPAdaptersConfigBaseURL = @"https://engine.sponsorpay.com/sdk-config";

static NSString *const kSPMBEJSCoreURL = @"http://be.sponsorpay.com/mobile";
