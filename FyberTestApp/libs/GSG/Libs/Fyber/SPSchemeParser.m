...
+ (SPScheme *)parseUrl:(id)url
{
    ...
    NSString *clickThroughURLString = [[parameters[SPTPNClickThroughURL] SPURLDecodedString] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    NSString *trackingURLString = [[parameters[SPTPNTrackingURLParameter] SPURLDecodedString] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    ...
    scheme.trackingUrl = [NSURL URLWithString:trackingURLString];
    scheme.showAlert = [parameters[SPTPNShowAlertParameter] isEqualToString:@"true"];

    scheme.urlString = [[parameters[SPRequestURLParameterKey] SPURLDecodedString] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
