...
/** Fetches the amount of a given currency earned since the last time this method was invoked for the current user ID / app ID combination.
 ...
 @param currency The currency name that will be fetched. A nil currency fetches the default currency
 */

- (void)fetchDeltaOfCoinsWithCurrencyId:(NSString *)currency;
