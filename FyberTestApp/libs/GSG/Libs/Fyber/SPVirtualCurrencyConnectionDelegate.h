...
- (void)virtualCurrencyConnector:(SPVirtualCurrencyServerConnector *)connector
  didReceiveDeltaOfCoinsResponse:(double)deltaOfCoins
             latestTransactionId:(NSString *)transactionId DEPRECATED_MSG_ATTRIBUTE("This method is deprecated. Please use virtualCurrencyConnector:didReceiveDeltaOfCoins:currencyName:latestTransactionId");
