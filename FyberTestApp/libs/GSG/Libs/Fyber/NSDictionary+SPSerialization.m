...
- (NSString *)SPComponentsJoinedBy:(NSString *)entrySeparator keyValueSepator:(NSString *)keyValueSeparator
{
...
#pragma mark - Adapters mapping

static NSString * const SPAdapterMappingNameKey = @"name";
static NSString * const SPAdapterMappingSettingsKey = @"settings";

- (NSString *)adapterName {
    return self[SPAdapterMappingNameKey];
}

- (id)adapterSettings {
    return self[SPAdapterMappingSettingsKey];
}
